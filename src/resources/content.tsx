...
const newsletter: Newsletter = {
  ...
  description: (
    <>Security, automation, and the systems that connect them — straight to your inbox.</>
  ),
};
...
const home: Home = {
  ...
  subline: (
    <>
      I build AI agents and automation systems that handle the repetitive, high-stakes parts of
      cloud security — so humans can focus on the problems that actually need them.
    </>
  ),
};
  ...
  intro: {
    ...
    description: (
      <Column fillWidth gap="m">
        <Text>
          I’m a cloud security engineer based in Israel. The environment changes, the threats
        ...
        <Text>
          ...
          primarily in the Microsoft ecosystem — Entra ID, Intune, Defender, Azure.
        </Text>
    ...
    experiences: [
      {
        ...
        achievements: [
          <>
            ...
            handled the edge cases that always come up mid-migration, and documented everything so
            the client could own it afterward.
          </>,
          <>
          ...
          <>
            Built Azure automations for clients — Logic Apps workflows, HiBob-to-on-prem AD sync
            connector, user lifecycle automation. The kind of work that stops someone from manually
            running a PowerShell script every Monday morning.
          </>,
          <>
          ...
          <>
            ...
            reporting. 100% SLA hit rate. Built reusable hunting queries and IR playbooks along the
            way.
          </>,
        ],
        images: [],
      },
      {
        ...
        achievements: [
          <>
            Served in a combat infantry unit for three years, ending as a Staff Sergeant leading a
            small team. The work was physically demanding and operationally serious — you learned
  ...
  interests: {
    ...
    items: [
      ...
      },
      {
        ...
        description: (
          <>
            Docker Swarm cluster on three nodes — Traefik, Infisical, a growing list of self-hosted
            services. Where I break things on purpose. Most of my blog posts start here.
          </>
        ),
        icon: "wrench",
      },
