...
| Post | Tag |
|------|-----|
| Zero Trust Is Not a Product | Security |
| Conditional Access in Practice | Security |
| Endpoint Hardening & Zero Trust Control | Security |
| Zero Trust for AI Agents | Security |
| Identity-First Security | Security |
| Vibe Coding & AI Workflows | AI |
| Homelab Docker Swarm | Infrastructure |
| Claude Code Config | Dev Tools |
| Netlogon RPC Sealing Playbook | Security |
| FleetWatch: From Script to System | Dev Tools |
| Claude Code Config v2 | Dev Tools |
| Claude Code Daily Workflow | Dev Tools |
| Phishing-Resistant MFA Rollout | Security |
| Smart Offboarding Orchestration | Security |
| The JumpCloud Exit Playbook | Security |
...
**Blog angle:** Building a personal automation platform on Azure — VPS, WAF, Swarm, and n8n as the brain.
**Tag:** Infrastructure / Automation
**Status:** In Progress

### 8. SMB over QUIC + Azure AD App Proxy (Defense Tech Client A)
**What it is:** Replace VPN-based file server access with SMB over QUIC. Publish legacy internal app (Priority ERP) via Azure AD Application Proxy with Conditional Access. 31 tasks, on hold.
**Blog angle:** Killing the VPN for file access — SMB over QUIC and App Proxy as a zero-trust remote access pair.
**Tag:** Security / Infrastructure
**Status:** On Hold


### 10. Entra Join Migration (Defense Tech Client B)
...
**Blog angle:** TBD — needs more project detail.
**Tag:** Infrastructure
**Status:** In Progress

### 12. Google Workspace → Entra ID Federation (OT Security Client)
...
### 14. GCP Integrations / CASB (Academic Sector Client)
...
## ⚪ Tier 3 — Backlog (Less Context / Smaller Scope)

### 15. HR Automations (Veterinary Marketplace Client)
**What it is:** HR-driven lifecycle automations for a new client. 9 tasks, in progress.
**Blog angle:** TBD — needs more project detail.
**Tag:** Automation

### 16. Zero Trust Rollout (Defense Tech Client B) — Retrospective
...
**Blog angle:** TBD — needs more detail.
**Tag:** Security
**Status:** Active

---

## 🔑 Client Name Key (Private — Not for Publishing)

| Sanitized Name | Real Client |
|---|---|
| FinTech Client | eToro |
| Energy Sector Client | EDF |
| OT Security Client | Claroty |
| Trading Platform Client | investing.com |
| Defense Tech Client A | BST |
| Defense Tech Client B | Controp |
| Veterinary Marketplace Client | VetMarket |
| Startup Client | Entropy |
| Academic Sector Client | Open University |
